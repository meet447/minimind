...
> **English-first fork** of [jingyaogong/minimind](https://github.com/jingyaogong/minimind). Product target: **MiniMind-128** (~123M, 16×768) that writes sensible English for basic use on a single T4. Code, CLI, eval, and docs are English. Plan: [docs/ROADMAP.md](./docs/ROADMAP.md). Weights: [meet447/minimind](https://huggingface.co/meet447/minimind). Chat: [meet447/minimind-chat](https://huggingface.co/spaces/meet447/minimind-chat).
