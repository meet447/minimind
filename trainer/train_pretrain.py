...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str, default="../dataset/pretrain_t2t_mini.jsonl", help="Pretraining data path")
    parser.add_argument('--from_weight', default='none', type=str, help="Base checkpoint to train from; none starts from scratch")
